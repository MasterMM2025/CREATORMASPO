(function () {
  ...
  function stylePricesForPage(page, styleName) {
    ...
    priceGroups.forEach((g) => {
      // Moduły direct ze styl-wlasny.js mają własny system ceny (kolor/font/pozycjonowanie)
      // i nie powinny być nadpisywane przez styl elegancki.
      if (g.getAttr && g.getAttr("directModuleId")) return;
