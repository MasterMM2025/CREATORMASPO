(function () {
  ...
  function extractCustomStylePayload(payload) {
  ...
  function loadCustomStylesFromLocalStorage() {
    try {
      ...
      return normalizeCustomStyleList(extractCustomStylePayload(JSON.parse(raw || "[]")));
    } catch (_err) {
      return [];
    }
  }
  ...
  async function loadCustomStylesFromRemoteStorage() {
    ...
    return normalizeCustomStyleList(extractCustomStylePayload(payload));
  }
